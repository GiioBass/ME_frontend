...
const NavigationGrid: React.FC<NavigationGridProps> = ({ exits, onMove }) => {
    return (
        <div className="my-2 p-2 rounded-xl border border-stitch-blue/20 bg-black/20 shadow-[0_0_20px_rgba(6,182,212,0.05)] flex-shrink-0">
            <div className="grid grid-cols-4 gap-2">
                <button
                    className={`p-3 relative z-10 flex items-center justify-center rounded-lg transition-all active:scale-95 ${exits['west']
                        ...
                        : 'opacity-30 cursor-not-allowed bg-black/40 text-gray-500 border border-gray-800'}`}
            ...
            <div className="flex justify-center gap-2 mt-4 text-xs font-bold uppercase tracking-widest">
